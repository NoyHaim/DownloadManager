...
public class Manager {
    ...
    public Manager(String url, int numberOfThreads) {
        ...
        this.metadataPath = this.fileName.substring(0, this.fileName.lastIndexOf('.')) + "_metadata";
        this.tempMetadataPath = this.fileName.substring(0, this.fileName.lastIndexOf('.')) + "_temp_metadata";
    ...
    public void initURL() {
        try {
            ...
            // 20 is an optimizes size of file which file with smaller length will need only 1 connection
    ...
    public void startDownload() {
        ...
        for(int i = 0; i < this.numberOfConnection; i++) {
            ...
            // - 1 is for cases we do not want to include the last number in a range
